  ...
  return (
    ...
    <div className={`${styles.xPadding}  py-20`}>
      ...
      <Card className="bg-gray-800 lg:w-[400px] border-gray-800">
          ...
          /*<DynamicTicker endTime="2024-04-11T23:49:00Z" />*/
            <H4 className='py-4 text-white text-xl font-bold'>Distribution on going v.3</H4>
          </CardHeader>
          <div className="mx-5">
          <Progress
          value={92.9}
          ...
          <div className="flex justify-between px-5 mt-[-4px]">
            <h4 className="font-bold text-sm text-orange-200">205.25 SOL</h4>
